...
private:
	...
	void onMessage(const TcpConneciontPtr &conn,Buffer *buf,Timestamp receiveTime)
	{
...
int main(int argc,char *argv[])
{
	...
	{
		EventLoop loop;
		InetAddr serverAddr(argv[1],2037);
